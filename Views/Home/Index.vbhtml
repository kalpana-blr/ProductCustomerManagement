...
<table class="table">
    ...
    <td>
        @*@Html.ActionLink("Edit", "Edit", "Products", New With {.id = product.ProductID}, Nothing) |
        @Html.ActionLink("Delete", "Delete", "Products", New With {.id = product.ProductID}, Nothing)*@
    ...
    <td>
        @*@Html.ActionLink("Edit", "Edit", "Customers", New With {.id = customer.CustomerID}, Nothing) |
        @Html.ActionLink("Delete", "Delete", "Customers", New With {.id = customer.CustomerID}, Nothing)*@
        ...
        <p>@Html.ActionLink("New Product", "Create", "Products")</p>
        <p>@Html.ActionLink("New Customer", "Create", "Customers")</p>
